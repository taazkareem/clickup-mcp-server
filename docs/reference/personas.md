...
**Disabled Value:**
```text
delete_task,delete_bulk_tasks,delete_task_link,delete_task_dependency,delete_space,delete_folder,delete_list,delete_goal,delete_key_result,delete_document,delete_view,delete_space_tag,delete_chat_channel,delete_user_group,delete_webhook
```