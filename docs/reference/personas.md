...
| Category & Tool | Auditor | Task Worker | Time Specialist | Project Manager | Content Manager | Workspace Admin | Dev / Integrator | Safe Power User |
|:---|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|
| **Workspace** | | | | | | | | |
| `get_workspace` | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| `get_audit_logs` | ✅ | | | | | ✅ | | ✅ |
...
**Value:** `get_workspace,get_workspace_tasks,get_audit_logs,list_spaces,get_space,create_space,update_space,delete_space,set_space_permissions,get_folder,create_folder,update_folder,delete_folder,move_folder,set_folder_permissions,list_lists,get_list,create_list,update_list,delete_list,move_list,set_list_permissions,list_webhooks,create_webhook,update_webhook,delete_webhook,list_user_groups,create_user_group,update_user_group,delete_user_group,invite_guest,get_guest,edit_guest,remove_guest,add_guest_to_task,remove_guest_from_task,add_guest_to_list,remove_guest_from_list,add_guest_to_folder,remove_guest_from_folder,submit_feedback`

#### 7. Developer / Integrator
Focused purely on Webhooks, Custom Fields, and programmatic bulk Task manipulation.
**Value:** `get_workspace,get_task,create_task,update_task,delete_task,get_workspace_tasks,create_bulk_tasks,update_bulk_tasks,move_bulk_tasks,delete_bulk_tasks,list_custom_fields,create_custom_field,set_custom_field_value,remove_custom_field_value,list_webhooks,create_webhook,update_webhook,delete_webhook,submit_feedback`

#### 8. Safe Power User
Enables all tools except destructive structural or bulk deletions. Set using `DISABLED_TOOLS`.
**Disabled Value:** `delete_task,delete_bulk_tasks,delete_task_link,delete_task_dependency,delete_space,delete_folder,delete_list,delete_goal,delete_key_result,delete_document,delete_view,delete_space_tag,delete_chat_channel,delete_user_group,delete_webhook`