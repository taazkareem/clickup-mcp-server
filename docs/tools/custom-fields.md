...
- **Data Protection**: The `remove_value` action is gated by the `delete_task` security flag. If destructive actions are disabled for your persona, this action will be blocked to prevent accidental data loss.
