...
![ClickUp MCP Server Premium Image]([assets/images/header_image.png](https://github.com/taazkareem/clickup-mcp-server/blob/main/assets/images/header_image.png
))
